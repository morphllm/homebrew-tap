class Mh < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://code.morphllm.com/bhaktateas/cli/releases/download/v0.1.0/mh-darwin-arm64"
      sha256 "e15a1a83dc19027dd5963bc5627a95eae3c54f0ba36a61aa4ae6ca79429fa690"
    else
      url "https://code.morphllm.com/bhaktateas/cli/releases/download/v0.1.0/mh-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://code.morphllm.com/bhaktateas/cli/releases/download/v0.1.0/mh-linux-arm64"
      sha256 "80a4c34e4a484efb023273004856057d5202e4ec3987dbf62b59caf97ac420e1"
    else
      url "https://code.morphllm.com/bhaktateas/cli/releases/download/v0.1.0/mh-linux-amd64"
